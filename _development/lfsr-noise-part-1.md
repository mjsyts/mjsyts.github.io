...
[^nes_noise]: NESdev Wiki. *APU Noise*. [https://www.nesdev.org/wiki/APU_Noise](https://www.nesdev.org/wiki/APU_Noise).

[^gb_noise]: GbdevWiki. *Gameboy sound hardware — Noise Channel*. [https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#Noise_Channel](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#Noise_Channel).
